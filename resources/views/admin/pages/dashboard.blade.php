            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Happy Clients</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $clientTotal ?? '0' }}
                                    {{-- {{ $userTotal ?? '0' }} --}}
                                </h5>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Project's Done</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $projectTotal ?? '0' }}
                                    {{-- {{ $customerTotal ?? '0' }} --}}
                                </h5>
            ...
            <div class="card">
                <div class="card-body p-3">
                    <div class="row">
                        <div class="col-8">
                            <div class="numbers">
                                <p class="text-sm mb-0 text-capitalize font-weight-bold">Our Team</p>
                                <h5 class="font-weight-bolder mb-0">
                                    {{ $ourTeamTotal ?? '0' }}
                                    {{-- {{ $barangTotal ?? '0' }} --}}
                                </h5>
